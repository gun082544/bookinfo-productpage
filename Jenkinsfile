...
"""
    ...
    PROJECT_KEY = "gun-bookinfo-productpage"
    PROJECT_NAME = "gun-bookinfo-productpage"
  }
        ...
        container('jnlp') {
          ...
          script {
            ...
            scmVars = git branch: "${BRANCH_NAME}",
                          ...
                          url: 'git@github.com:gun082544/bookinfo-productpage.git'
          } // End script
        } // End container
      } // End steps
    } // End stage
        ...
        container('docker') {
          script {
            ...
            docker.withRegistry('https://ghcr.io', 'gun-ghcr') {
              ...
              docker.build('ghcr.io/gun082544/bookinfo-productpage:${ENV_NAME}').push()
